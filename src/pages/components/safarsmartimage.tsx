    ...
    <div className="w-full px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="flex flex-col gap-4 items-start">
          <Image
            src="/safarsmart/7 (1)_webthumb_1736924800.jpg"
            alt="Scooty"
            width={360}
            height={200}
          ...
          />
          <Image
            src="/safarsmart/8 (1)_webthumb_1736924800.jpg"
            alt="Bike"
            width={360}
            height={200}
            className="object-cover w-full h-auto rounded-md"
        ...
        <div className="flex justify-center relative">
          ...
          {!isPlaying && (
            ...
            >
              <Image
                src="/safarsmart/Safar-Smart_816x516_webthumb_1698233052.jpg"
                alt="Thumbnail"
                width={597.84}
                height={378.04}
                className="rounded-md object-cover w-[597.84px] h-[378.04px] max-w-full"
        ...
        <div className="flex flex-col gap-4 items-end">
          <Image
            src="/safarsmart/5 (1)_webthumb_1736924800.jpg"
            alt="Auto"
            width={360}
            height={200}
            className="object-cover w-full h-auto rounded-md"
          />
          <Image
            src="/safarsmart/6 (1)_webthumb_1736924800.jpg"
            alt="Cart"
            width={360}
            height={200}
            className="object-cover w-full h-auto rounded-md"
